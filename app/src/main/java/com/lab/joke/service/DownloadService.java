...
import com.lab.joke.view.ui.MainActivity;
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    if (is != null) {
                        File rootFile = new File(Environment.getExternalStorageDirectory(), "/wonderworld");
                        if (!rootFile.exists() && !rootFile.isDirectory())
                            rootFile.mkdir();

                        //tempFile = new File(Environment.getExternalStorageDirectory(), "/wonderworld/" + url.substring(url.lastIndexOf("/"), url.indexOf("?")) + "_" + notificationId + ".apk");
                        tempFile = new File(Environment.getExternalStorageDirectory(), "/wonderworld/" + "wonderworld.apk");
                        if (tempFile.exists())
                            tempFile.delete();
            ...
            if (msg != null) {
                switch (msg.what) {
                    ...
                    case 1:
                        break;
                    case 2:
                        contentIntent = PendingIntent.getActivity(DownloadService.this, msg.arg1, new Intent(DownloadService.this, MainActivity.class), 0);
